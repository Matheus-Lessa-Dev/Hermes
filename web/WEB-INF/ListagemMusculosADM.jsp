...
<body>
    ...
    <h1>Listagem de Músculos</h1>
    
 
    <% for (int i = 0; i < lista.size(); i++) {%>
    <div class="maeretanguloMusculo"> 
        <div class="retanguloMusculo"> <%=lista.get(i).getNome()%> </div>
        <div>  <a href="selecionar?id=<%=lista.get(i).getID()%>" class="TresretanguloMusculo"> ⁝ </a> </div>
    </div> 
  <% } %>

    <a href="CadastrarMusculosADM" class="opTxt"> <div class="opcoes"> Adicionar Músculo</div> </a>
</body>
