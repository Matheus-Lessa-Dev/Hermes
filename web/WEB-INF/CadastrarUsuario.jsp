...
#msgErro{
    ...
    <form id="Login" action="Cadastro" method="post">
        <div id="maeEmail"> <input type="text" placeholder="Insira seu Nome" name="nome" id="nome"> </div>
        <div id="maeEmail"> <input type="text" placeholder="Insira seu Email" name="email" id="email"> </div>
        <div id="maeSenha"> <input type="password" placeholder="Insira sua Senha" name="senha" id="senha"> </div>
        <div id="LoginBotao"> 
