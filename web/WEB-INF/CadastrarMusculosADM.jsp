...
<div id="conteudoPrincipal">
    ...
    <div id="maeNomeMusculo">
        <form action="novoMusculo" method="post" enctype="multipart/form-data">
            <!-- Nome do Músculo -->
            <input type="text" name="nome" placeholder="Nome do Músculo" id="NomeMusculo" required>
            ...
            <label for="descricaoImagem" id="DescImgTXT">Descrição da imagem: &nbsp</label>
            <input type="text" name="descricao" id="descricao" placeholder="Exemplo: Imagem ilustrativa do músculo..." required>
</div>
